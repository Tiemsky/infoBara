        ...
        <div class="row">
            ...
            <div class="col-lg-9 col-md-12">
                ...
                <div class="main-item">
                    ...
                    <div class="company-logo">
                        <a href="">
                        <img src="{{ asset('uploads/logo/'.$company->logo) }}" alt="avatar">
                        </a>
                    </div>
                    ...
                    <div class="description">
                        <h5 class="title"><a href=""></a>{{ $company->slug }}</h5>
                        <div class="candidate-listing-footer">
                            <ul>
                                <li><i class="flaticon-work"></i> UX Designer</li>
                                <li><i class="flaticon-pin"></i>{{ $company->country }}</li>
                                <li><i class=""></i>{{ $company->state }} </li>
                                <li><i class=""></i>{{ $company->city }} </li>
                                <li><i class=""></i>Joined date: {{ $company->created_at }} </li>
                ...
                <div class="job-description mb-40">
                    <h3 class="heading-2 text-center">Company Description</h3>
                    <p>{{ $company->description }}</p>
                </div>
                <!-- Company description end -->
                {{-- Counting Total number of job before deplaying them --}}
                <?php $counter =0; ?>
                ...
                <div class="job-description mb-40">
                    <h3 class="title text-center">{{ $counter }} Job(s) found</h3>
                    <p></p>
                </div>
