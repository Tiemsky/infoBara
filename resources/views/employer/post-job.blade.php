...
<div class="dashboard">
    ...
    <div class="submit-address dashboard-list">
        <form method="POST" action="{{ route('create-a-job') }}">
            @csrf
                ...
                <div class="row pad-20">
                    <div class="col-lg-6 col-md-6 col-sm-12">
                        <div class="form-group">
                            ...
                            <input type="text" class="input-text" name="job-title" placeholder="Job Title" value="{{ old('job-title') }}">
                        </div>
                        @error('job-title')
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-12">
                        <div class="form-group">
                            ...
                            <input type="text" class="input-text" name="position" placeholder="Position (Ex: Senior Developper)" value="{{ old('position') }}">
                        </div>
                        @error('position')
                            <span class="" role="alert">
                                <p class="text-danger" >{{$message}}</p>
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-12">
                        <div class="form-group">
                           ...
                           <input class="input-text" type="text" name="deadline" id="datepicker" placeholder="30-10-2020">
                        </div>
                        @error('deadline')
                            <span class="" role="alert">
                                <p class="text-danger" >{{$message}}</p>
                    ...
                    <div class="col-lg-12">
                        <div class="form-group">
                            <label>Role</label>
                            <textarea class="input-text" name="role" placeholder="Role">{{ old('role') }}</textarea>
                        </div>
                        @error('role')
                        <span class="" role="alert">
                            <p class="text-danger" >{{$message}}</p>
                    ...
                    <div class="col-lg-12">
                        <div class="form-group">
                            ...
                            <textarea class="input-text" name="job_description" placeholder="Detailed Information">{{ old('job_description') }}</textarea>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-6">
                        <div class="post-btn">
                            <input type="submit" class="btn btn-md button-theme" value="Post a job">
