...
(function ($) {
    ...
    $(document).ready(function ()
    {
            $('select[id="country"]').on('click',function(){
               var countryID = $(this).val();
               if(countryID)
               {
                  jQuery.ajax({
                     url : '/getCountry/getState/' +countryID,
                     type : "GET",
                     dataType : "json",
            ...
            $('select[id="state"]').on('click',function(){
               var stateID = $(this).val();
               if(stateID)
               {
                  jQuery.ajax({
                     url : '/getCountry/getCity/' +stateID,
                     type : "GET",
                     dataType : "json",
                     success:function(data)
                     {
                        ...
                        jQuery.each(data, function(key,value){
                           $('select[id="city"]').append('<option value="'+ key +'">'+ value +'</option>');
                        });
                     }
                  });
               }
